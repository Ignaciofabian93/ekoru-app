...
import { ArrowLeftRight, DollarSign, PackageSearch, Package, ScanLine, Target, LucideIcon } from "lucide-react";
...
import ImpactPreviewCard from "../cards/environment/impactPreview";
...
export default function ProductForm({
  ...
  return (
    <form id="product-form" onSubmit={handleSubmit} className="space-y-6">
      ...
      {/* Tags */}
      {isPersonProfile && (formData as Product).isExchangeable && (
        <TagSelector
      ...
      <ImpactPreviewCard isPersonProfile={isPersonProfile} environmentalImpact={environmentalImpact} />
    </form>
  );
}
